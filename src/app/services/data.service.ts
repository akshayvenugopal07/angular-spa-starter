...
export class DataService {
	...
	getSavedLocations(params): Observable<any> {
		return this.http.get<any>(environment.ENDPOINT + '/mockList', { params });
	}

	getLocationList(params): Observable<any> {
		return this.http.get<any>(environment.ENDPOINT + '/mockloc', { params });
	}
}
